...
import tree from './pose_images/tree.png'
...
import dumbbellCurl from './pose_images/dumbbell_curl.jpeg'
import squat from './pose_images/squat.png'
...
export const poseList = {
    ...
    Squat: {
        name:"Squat",
        description:'Squat is a strength training exercise that primarily targets the muscles of the lower body, including the glutes, quadriceps, hamstrings, and calves. The exercise involves standing with your feet shoulder-width apart, keeping your back straight, and lowering your body by bending at the knees and hips as if you\'re sitting down on an imaginary chair',
        benefit:'Squats offer many benefits for the body, including: Building Lower Body Strength, Improving Mobility and Flexibility, Enhancing Athletic Performance, Boosting Metabolism and Burning Calories, Strengthening Core Muscles, Improving Bone Density',
        image: squat,
        type: REP_POSE,
        defaultNum: 5,
        chartColor: "#ff844e"
...
export const classificationPhysicalEnum = {
    DumbbellCurl: {
        upClassNo : 1,
        upProbability: 0.95,
        downClassNo : 0,
        downProbability: 0.9998,
        defaultStatus: 'Down'
    },
    Squat: {
        upClassNo : 3,
